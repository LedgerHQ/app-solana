...
// EXTRA_ID_TYPE_SOLANA_TEMPLATE (0x03):
//   [0]     type byte (0x03)
//   [1..8]  template_id, big-endian uint64_t (TEMPLATE_ID_SIZE bytes)
//   Total:  EXTRA_ID_SOLANA_TEMPLATE_MIN_SIZE bytes
#define EXTRA_ID_NATIVE_MIN_SIZE          1
#define EXTRA_ID_SOLANA_TEMPLATE_MIN_SIZE (1 + TEMPLATE_ID_SIZE)
