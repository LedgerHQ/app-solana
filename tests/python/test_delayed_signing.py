...
class TestDelayedSigning:
    ...
    def test_delayed_signing_valid_flow(self, sol, scenario_navigator, root_pytest_dir):
    ...
    def test_delayed_signing_two_consecutive_flows(self, sol, scenario_navigator, root_pytest_dir, test_name):
        ...
        with sol.send_async_sign_message_preview(SOL.SOL_PACKED_DERIVATION_PATH, preview_tx1):
            scenario_navigator.review_approve(path=root_pytest_dir, test_name=test_name + "_1")
    ...
    def test_delayed_signing_preview_refused(self, sol, scenario_navigator, root_pytest_dir):
    ...
    def test_delayed_signing_twice_fails(self, sol, scenario_navigator, root_pytest_dir):
    ...
    def test_delayed_signing_different_amount_fails(self, sol, scenario_navigator, root_pytest_dir):
    ...
    def test_delayed_signing_different_recipient_fails(self, sol, scenario_navigator, root_pytest_dir):
    ...
    def test_delayed_signing_different_derivation_path_fails(self, sol, scenario_navigator, root_pytest_dir):
    ...
    def test_delayed_signing_different_message_length_fails(self, sol, scenario_navigator, root_pytest_dir):
