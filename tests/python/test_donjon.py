...
# from .apps import solana_utils as RLO
...
#         sol.provide_trusted_name(RLO.JUP_MINT_ADDRESS,
#                                  destination.encode('utf-8'),
#                                  RLO.FOREIGN_ADDRESS_STR.encode('utf-8'),
#                                  CHAIN_ID,
#                                  challenge=challenge)
...
#         sol.provide_trusted_name(RLO.JUP_MINT_ADDRESS,
#                                  destination.encode('utf-8'),
#                                  RLO.FOREIGN_ADDRESS_STR.replace('A', 'B').encode('utf-8'), # simulation of a compromised backend
#                                  CHAIN_ID,
#                                  challenge=challenge)
